...
(function () {
  ...
  var translations = {
    en: {
      ...
      'index.hero.subtitle': 'I build reliable, scalable digital solutions – from modern web applications to robust backend systems. Let\'s turn your idea into reality.',
      ...
      'about.bio1':          'I\'m Thomas, a freelance software engineer based in Germany with a passion for crafting clean, efficient, and maintainable software. I specialise in full-stack development with a strong focus on .NET/C# backends and Angular/React frontends.',
      'about.bio2':          'Over the years I\'ve worked across a variety of industries — from e-commerce and finance to broadcasting and software licensing — helping businesses design, build, and scale their digital products. Whether you need a brand-new application, a modernisation of a legacy system, or just an extra pair of hands on your team, I\'m here to help.',
      'about.bio3':          'When I\'m not writing code, you\'ll find me exploring new technologies or enjoying the great outdoors.',
      ...
      'contact.details.desc':            'Feel free to reach out via email or connect with me on LinkedIn. I\'m open to freelance engagements, consulting, and contract work.',
      'contact.email.label':             'Email',
      'contact.location.label':          'Location',
      'contact.location.value':          'Germany (Remote & On-Site)',
      ...
      'contact.form.success.text':       'Thank you for reaching out. I\'ll get back to you within one business day.',
    ...
    de: {
      ...
      'index.hero.subtitle': 'Ich entwickle zuverlässige und skalierbare digitale Lösungen – von modernen Webanwendungen bis hin zu robusten Backend-Systemen. Lassen Sie uns Ihre Idee gemeinsam umsetzen.',
      ...
      'about.hello':         'Hallo! 👋',
      'about.bio1':          'Ich bin Thomas, ein Freelance Software Engineer aus Deutschland mit einer Leidenschaft für saubere, effiziente und wartbare Software. Ich spezialisiere mich auf Full-Stack-Entwicklung mit Schwerpunkt auf .NET/C# Backends und Angular/React Frontends.',
      'about.bio2':          'Im Laufe der Jahre habe ich in verschiedenen Branchen gearbeitet – von E-Commerce und Finanzen bis hin zu Rundfunk und Software-Lizenzierung – und Unternehmen dabei geholfen, ihre digitalen Produkte zu entwerfen, zu entwickeln und zu skalieren. Ob Sie eine neue Anwendung, die Modernisierung eines Legacy-Systems oder einfach eine zusätzliche Unterstützung für Ihr Team benötigen – ich bin für Sie da.',
      'about.bio3':          'Wenn ich nicht gerade programmiere, entdecke ich neue Technologien oder genieße die Natur.',
      ...
      'contact.details.desc':            'Kontaktieren Sie mich per E-Mail oder verbinden Sie sich mit mir auf LinkedIn. Ich bin offen für Freelance-Aufträge, Consulting und Projektarbeit.',
      'contact.email.label':             'E-Mail',
      'contact.location.label':          'Standort',
      'contact.location.value':          'Deutschland (Remote & Vor-Ort)',
      ...
      'contact.form.success.text':       'Danke für Ihre Nachricht. Ich melde mich innerhalb eines Werktages.',
